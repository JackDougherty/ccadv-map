...
$.getJSON("points.geojson", function (data){
  var geoJsonLayer = L.geoJson(data, {
    pointToLayer: function( feature, latlng) {
      ...
      + "View <a href='ccadv-map/charts/'" + feature.properties.name + ".png' target='_blank'> top 3 services chart</a></br>"
      + "View <a href='ccadv-map/facts/'" + feature.properties.name + ".pdf' target='_blank'> fact sheet PDF</a></br>";
...
info.update = function (props) {
  this._div.innerHTML = '<h4>Connecticut Coalition Against Domestic Violence<br />Member Map 2017</h4>' +  (props ?
